          ...
          {Cart.map((items, i) => (
            <div key={i} className='w-full my-4 rounded flex flex-col md:flex-row p-4 bg-zinc-800 justify-between items-center'>
              ...
              <div className='flex mt-4 w-full md:w-auto items-center justify-between'>
                ...
                <button onClick={() => deleteItem(items._id)} className='bg-red-100 text-red-700 border border-red-700 rounded p-2 ms-12'>
                  <AiFillDelete />
                </button>
              </div>
            </div>
        ...
        <div className='mt-4 w-full flex items-center justify-end'>
          <div className='p-4 bg-zinc-800 rounded'>
            ...
            <div className='w-[100%] mt-3'>
              <button onClick={PlaceOrder} className='bg-zinc-100 rounded px-4 py-2 flex justify-center w-full font-semibold hover:bg-blue-400 hover:text-white transition-all duration-300'>
                Place your order
              </button>
            </div>
          </div>
