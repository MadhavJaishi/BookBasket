    ...
    <div className="bg-zinc-800 rounded p-4 flex flex-col">
      <Link to={`/view-book-details/${data._id}`}>
        <div className="">
          ...
          <p className="mt-2 text-zinc-300 font-semibold text-center">
            By {data.author}
          </p>
      ...
      {favourite && (
        <button
          ...
          className="bg-green-100 text-xl font-semibold px-4 py-2 mt-4 rounded border border-green-500 text-red-600 "
        >
